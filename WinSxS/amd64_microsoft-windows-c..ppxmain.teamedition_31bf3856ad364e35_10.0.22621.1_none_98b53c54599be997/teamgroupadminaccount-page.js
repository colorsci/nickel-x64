...
//
(() => {
    WinJS.UI.Pages.define("/webapps/shubOobe/view/teamgroupadminaccount-main.html", {
        ...
        ready: (element, options) => {
            ...
            require(['lib/knockout', 'corejs/knockouthelpers', 'legacy/bridge', 'legacy/events', 'teamgroupadminaccount-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, TeamGroupAdminAccountViewModel) => {
                ...
                let vm = new TeamGroupAdminAccountViewModel(this.resourceStrings);
                ko.applyBindings(vm);
