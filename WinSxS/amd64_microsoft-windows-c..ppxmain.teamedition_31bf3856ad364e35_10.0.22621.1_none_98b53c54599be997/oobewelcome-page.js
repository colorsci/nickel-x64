...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobewelcome-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'corejs/knockouthelpers', 'jsCommon/oobe-gesture-manager', 'legacy/bridge', 'legacy/core', 'legacy/events', 'oobewelcome-vm', 'lib/knockout-winjs'], (ko, KoHelpers, gestureManager, bridge, core, constants, WelcomeViewModel) => {
