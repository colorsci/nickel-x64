...
//
(() => {
    WinJS.UI.Pages.define("/webapps/shubOobe/view/teamdeviceaccountpageselector-main.html", {
        ...
        ready: (element, options) => {
            ...
            require(['lib/knockout', 'corejs/knockouthelpers', 'legacy/bridge', 'legacy/events', 'teamdeviceaccountpageselector-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, TeamDeviceAccountPageSelectorViewModel) => {
                ...
                let vm = new TeamDeviceAccountPageSelectorViewModel(this.resourceStrings);
                ko.applyBindings(vm);
