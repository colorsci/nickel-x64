...
//
(() => {
    WinJS.UI.Pages.define("/webapps/shubOobe/view/teamdomainjoin-main.html", {
        ...
        ready: (element, options) => {
            ...
            require(['lib/knockout', 'corejs/knockouthelpers', 'legacy/bridge', 'legacy/events', 'teamdomainjoin-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, TeamDomainJoinViewModel) => {
                ...
                let vm = new TeamDomainJoinViewModel(this.resourceStrings);
                ko.applyBindings(vm);
