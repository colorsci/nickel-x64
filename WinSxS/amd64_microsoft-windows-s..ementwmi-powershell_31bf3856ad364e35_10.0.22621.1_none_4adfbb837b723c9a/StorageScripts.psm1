...
class StorageIoDistribution
{
    ...
    [UInt64]$LatencySuccessCount13
    [UInt64]$LatencySuccessCount14
}
...
$PopulateStorageHistory = {
    ...
    elseif (($Object.Value.Version -ge 9) -and ($Object.Value.Version -le 11))
    {
    ...
    elseif ($Object.Value.Version -eq 12)
    {
        $Object.Value.PSObject.TypeNames.Insert( 1, "Microsoft.Windows.StorageManagement.StorageHistory_v12" )
        ...
        $Object.Value.BucketIoLatency[0]  =    128  * 10    # 128 us in 100ns
        $Object.Value.BucketIoLatency[1]  =    256  * 10    # 256 us in 100ns
        $Object.Value.BucketIoLatency[2]  =    512  * 10    # 512 us in 100ns
        $Object.Value.BucketIoLatency[3]  =      1  * 10000 # 1 ms in 100ns
        $Object.Value.BucketIoLatency[4]  =      4  * 10000 # 4 ms in 100ns
        $Object.Value.BucketIoLatency[5]  =     16  * 10000 # 16 ms in 100ns
        $Object.Value.BucketIoLatency[6]  =     64  * 10000 # 64 ms in 100ns
        $Object.Value.BucketIoLatency[7]  =    128  * 10000 # 128 ms in 100ns
        $Object.Value.BucketIoLatency[8]  =    256  * 10000 # 256 ms in 100ns
        $Object.Value.BucketIoLatency[9]  =    512  * 10000 # 512 ms in 100ns
        $Object.Value.BucketIoLatency[10] =   1000 * 10000 # 1000 ms in 100ns
        $Object.Value.BucketIoLatency[11] =   2000 * 20000 # 2000 ms in 100ns
        $Object.Value.BucketIoLatency[12] =  10000 * 10000 # 10000 ms in 100ns
        $Object.Value.BucketIoLatency[13] =  20000 * 10000 # 10000+ ms approx to 20000 ms in 100ns
    ...
    if ((($Object.Value.Version -eq 11) -or ($Object.Value.Version -eq 12)) -and ($Object.Value.TotalQueueIoCount -gt 0))
    {
...
$PopulateStorageHistoryAggregate = {
    ...
    if ($AggregateObject.Value.Version -eq 0)
    {
        ...
        elseif ($Object.Value.Version -eq 12)
        {
            $AggregateObject.Value.PSObject.TypeNames.Insert( 1, "Microsoft.Windows.StorageManagement.StorageHistoryAggregate_v12" )
        }
            ...
            foreach ($event in $events)
            {
                ...
                foreach ($iotype in $ioTypes)
                {
                    for ($sizeIndex = 0; $sizeIndex -lt $ioSizes.count; $sizeIndex++)
                    {
                        ...
                        if ($tempObject.Version -eq 1)
                        {
                            $countsData.PSObject.TypeNames.Insert(1, "Microsoft.Windows.StorageManagement.StorageIoDistribution_v1")
                        }
                        elseif ($tempObject.Version -eq 2)
                        {
                            $countsData.PSObject.TypeNames.Insert(1, "Microsoft.Windows.StorageManagement.StorageIoDistribution_v2")
                        }
...
function New-Volume
{
    ...
    Process
    {
        ...
        if ($PoolInstance)
        {
            ...
            {
                $arguments.Add("MinimumLogicalDataCopies", $MinimumLogicalDataCopies)
            }
            ...
            {
                $arguments.Add("WriteCacheReserveSize", $WriteCacheReserveSize)
            }
            ...
            {
                $arguments.Add("TrackValidData", $TrackValidData)
            }
